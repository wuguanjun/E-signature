...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(v->startActivityForResult(new Intent(this,HandWriteActivity.class),1));
        btn2.setOnClickListener(v->startActivityForResult(new Intent(this,LandscapeActivity.class),1));
    }
